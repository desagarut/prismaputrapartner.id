...
class Header_model extends CI_Model {
	...
	public function kabkota_total()
	{
		$sql = "SELECT COUNT(id) AS jumlah FROM tweb_wilayah WHERE  kabkota <> '0' AND kabkota <> '-' AND kecamatan = '0' AND desa = '0' AND dusun = '0' AND rw = '0' AND rt = '0'";
		$query = $this->db->query($sql);
		$data = $query->result_array();
		return $data;
	}
	
	public function kecamatan_total()
	{
		$sql = "SELECT COUNT(id) AS jumlah FROM tweb_wilayah WHERE  kecamatan <> '0' AND kecamatan <> '-' AND desa = '0' AND dusun = '0' AND rw = '0' AND rt = '0'";
		$query = $this->db->query($sql);
		$data = $query->result_array();
		return $data;
