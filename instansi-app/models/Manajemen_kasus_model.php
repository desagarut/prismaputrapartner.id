...
class Manajemen_kasus_model extends MY_Model
{
	...
	{
		$this->load->model('keluarga_model'); // Di-load di sini karena tidak bisa diload di constructor, karena keluarga_model juga load manajemen_kasus_model
