<?php class Keluarga_model extends CI_Model {
	...
	{
		parent::__construct();
		$this->load->model(['manajemen_kasus_model', 'penduduk_model', 'web_dokumen_model', 'config_model']);
	}
	...
	*/
	...
	private function buat_berkas_kk($data = '')
	{
		...
		$buffer = str_replace("*camat","\caps $h[nama_pimpinan]", $buffer);
		...
		$buffer = str_replace("*nip_pimpinan","$h[nip_pimpinan]", $buffer);
