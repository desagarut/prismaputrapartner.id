...
class Rtm extends Admin_Controller {
	...
	{
		parent::__construct();
		$this->load->model(['rtm_model', 'config_model', 'wilayah_model', 'manajemen_kasus_model']);
	...
	*/
	...
	public function anggota($id = 0)
	{
		...
		$data['program'] = $this->manajemen_kasus_model->get_peserta_program(3, $data['kepala_kk']['no_kk']);
		$this->set_minsidebar(1);
