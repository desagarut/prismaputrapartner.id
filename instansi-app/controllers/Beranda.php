...
class Beranda extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('manajemen_kasus_model');
	...
	public function index()
	{
		...
		$data['kabkota'] = $this->header_model->kabkota_total();
		$data['kecamatan'] = $this->header_model->kecamatan_total();

		$data['surat_masuk'] = $this->header_model->jumlah_surat_masuk();
		$data['surat_keluar'] = $this->header_model->jumlah_surat_keluar();
		$data['log_surat'] = $this->header_model->jumlah_surat_keluar_layanan();
	...
	{
		$data['list_program_bantuan'] = $this->manajemen_kasus_model->list_program();
