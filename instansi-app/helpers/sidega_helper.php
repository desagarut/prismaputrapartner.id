...
define("LOKASI_CONFIG_INSTANSI", 'instansi/config/');

define("LOKASI_SURAT_INSTANSI", 'instansi/template-surat/');

define("LOKASI_SURAT_FORM_INSTANSI", 'instansi/template-surat/form/');

define("LOKASI_SURAT_PRINT_INSTANSI", 'instansi/template-surat/print/');

define("LOKASI_SURAT_EXPORT_INSTANSI", 'instansi/template-surat/export/');

define("LOKASI_USER_PICT", 'instansi/upload/user_pict/');
...
define("LOKASI_FOTO_AREA", 'instansi/upload/gis/area/');

define("LOKASI_FOTO_GARIS", 'instansi/upload/gis/garis/');

define("LOKASI_DOKUMEN", 'instansi/upload/dokumen/');

define("LOKASI_PENGESAHAN", 'instansi/upload/pengesahan/');

define("LOKASI_WIDGET", 'instansi/widgets/');

define("LOKASI_GAMBAR_WIDGET", 'instansi/upload/widgets/');
...
define("BIDANGHUKUM", serialize(array(
 ...
 * Mengembalikan path lengkap untuk file favico instansi
 ...
 * gambar_institusi / KantorDesa

 *

 * Mengembalikan path lengkap untuk file logo instansi / kantor instansi
...
function gambar_institusi($nama_file, $type = FALSE, $file = FALSE)
 ...
 * Mengembalikan path file konfigurasi database instansi
...

{
	...
	$konfigurasi_database = LOKASI_CONFIG_INSTANSI . 'database.php';
...
// Untuk mengirim data ke sidega tracker
 ...
 * lokasi : lokasi folder berkas berada (contoh : instansi/arsip)
...

{
...

	{
...

		{
			...
			include(FCPATH . 'instansi-app/views/errors/html/error_404.php');
