...
<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Data Calon Pemilih</h5>
		<ul class="breadcrumb">
			...
			<div class="col-md-12">
					...
					<div class="card-header">
						<div class="col-sm-8 col-lg-9">
							<div class="row">
								<a href="<?= site_url("dpt/ajax_cetak/$o/cetak")?>" class="btn btn-box bg-purple btn-sm " title="Cetak Data" target="_blank" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Cetak Data" ><i class="fa fa-print "></i> Cetak</a>
								<a href="<?= site_url("dpt/ajax_cetak/$o/unduh")?>" class="btn btn-box bg-navy btn-sm " title="Unduh Data" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Unduh Data" target="_blank"><i class="fa fa-download"></i> Unduh</a>
								<a href="<?= site_url("dpt/ajax_adv_search")?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Pencarian Spesifik" class="btn btn-box btn-primary btn-sm " title="Pencarian Spesifik"><i class='fa fa-search'></i> Pencarian Spesifik</a>
								<a href="<?= site_url("dpt/clear")?>" class="btn btn-box btn-default btn-sm " title="Bersihkan Pencarian"><i class="fa fa-refresh"></i>Bersihkan</a>
							</div>
						</div>
