				...
				<div class="col-sm-8">
					<small>
						<ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item active"><a href="<?= site_url('sid_core') ?>"><?= strtolower($provinsi) ?> </a></li>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td nowrap>
														<a href="<?= site_url("sid_core/sub_desa/$id_provinsi/$id_kabkota/$data[id]") ?>" class="btn bg-purple btn-box btn-sm" title="Lihat Desa/Kel">Lihat Desa/Kel</a>
														<?php if ($this->CI->cek_hak_akses('h')) : ?>
															...
															<a href="#" data-href="<?= site_url("sid_core/delete/kecamatan/$data[id]") ?>" class="btn bg-maroon btn-box btn-sm" title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
														<?php endif; ?>
													</td>
