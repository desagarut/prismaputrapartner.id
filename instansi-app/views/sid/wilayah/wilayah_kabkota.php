<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-4">
					<h5 class="m-0">Daftar Kabupaten/Kota Prov. <?= $data['provinsi'] ?></h5>
				</div>
				<div class="col-sm-8">
					<small>
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="<?= site_url() ?>beranda">Beranda</a></li>
							<li class="breadcrumb-item"><a href="<?= site_url('identitas_instansi') ?>">wilayah </a></li>
							<li class="breadcrumb-item"><a href="#!"><?= strtolower($provinsi) ?></a></li>
						</ol>
					</small>
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<a href="<?= site_url("sid_core") ?>" class="btn btn-box btn-info btn-sm btn-sm" title="Kembali Ke Daftar Provinsi">
							<i class="fa fa-arrow-circle-left "></i>&nbsp;Kembali ke Daftar Provinsi
						</a>
					...
					<div class="card-header">
						<small>Wilayah Administratif <?= ucwords($this->setting->sebutan_provinsi) ?> : <?= $provinsi ?> </small>
					</div>
					<div class="card-body">
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td nowrap>
														<a href="<?= site_url("sid_core/sub_kecamatan/$id_provinsi/$data[id]") ?>" class="btn bg-purple btn-box btn-sm" title="Lihat Kecamatan">Lihat Kecamatan</a>
														<?php if ($this->CI->cek_hak_akses('h')) : ?>
															<a href="<?= site_url("sid_core/form_kabkota/$id_provinsi/$data[id]") ?>" class="btn bg-orange btn-box btn-sm" title="Ubah"><i class="fa fa-edit"></i></a>
													...
													<td class="bilangan"><a href="<?= site_url("sid_core/sub_kecamatan/$data[id]") ?>" title="Rincian Sub Wilayah"><?= $data['jumlah_kecamatan'] ?></a></td>
