										...
										<div class="row">
											<div class="col-sm-12">
												<div class="form-group">
													<label class="col-sm-3 control-label" for="provinsi">Nama Provinsi</label>
													<div class="col-sm-7">
														<input id="provinsi" class="form-control input-sm nama_terbatas required" maxlength="100" type="text" placeholder="Nama  Provinsi" name="provinsi" value="<?= $provinsi ?>">
													</div>
												</div>
											</div>
											<?php if ($provinsi) : ?>
