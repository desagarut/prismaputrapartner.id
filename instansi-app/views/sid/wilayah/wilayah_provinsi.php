					...
					<div class="card">
						<div class="card-header">
							<?php if ($this->CI->cek_hak_akses('h')) : ?>
								<a href="<?= site_url('sid_core/form_provinsi') ?>" class="btn btn-box btn-success btn-sm pull-left" title="Tambah Data"><i class="fa fa-plus"></i> Tambah</a>
							<?php endif; ?>
							<a href="<?= site_url("$this->controller/dialog/cetak") ?>" class="btn btn-box bg-purple btn-sm" title="Cetak Data" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Cetak Data"><i class="fa fa-print "></i> Cetak</a>
							<a href="<?= site_url("$this->controller/dialog/unduh") ?>" title="Unduh Data" class="btn btn-box bg-navy btn-sm" title="Unduh Data" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Unduh Data"><i class="fa fa-download"></i> Download</a>
											...
											<tbody>
												...
												?>
													<tr>
														...
														<td nowrap>
															<a href="<?= site_url("sid_core/sub_kabkota/$data[id]") ?>" class="btn bg-purple btn-box btn-sm" title="Lihat Kab/Kota">Lihat Kab/Kota</a>
															<?php if ($this->CI->cek_hak_akses('h')) : ?>
