<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h4 class="m-0">Pengelolaan Data RT</h4>
				</div>
				<!-- /.col -->
				<div class="col-sm-6">
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<a href="<?= site_url("sid_core/sub_rt/$id_provinsi/$id_kabkota/$id_kecamatan/$id_desa/$id_rw") ?>" class="btn btn-box btn-info btn-sm btn-sm" title="Kembali Ke Daftar RT">
