			...
			<div class="col-md-3">
				...
				<div class="card card-primary">
					<div class="card-body box-profile text-center">
						...
						<?php endif; ?>
						<br />
						<p class="text-muted text-center text-sm"> (Kosongkan jika tidak ingin mengubah foto)</p>
						<br />
			...
			<div class="col-md-9">
				<div class='card'>
					<div class="card-header">
						<a href="<?= site_url('penduduk/clear') ?>" class="btn btn-box btn-info btn-sm " title="Kembali Ke Data Kependudukan"><i class="fa fa-arrow-left"></i> Kembali</a>
					</div>
					<div class='card-body'>
