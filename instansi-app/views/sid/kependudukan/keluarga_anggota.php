...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4 class="m-0">Daftar Anggota Keluarga</h4>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-hover tabel-rincian">
						<tbody>
							...
							<tr>
								<td>
									<?= ($program['programkerja']) ? anchor("program_tambahan/peserta/2/$kepala_kk[no_kk]", 'Program Tambahan', 'target="_blank"') : 'Program Tambahan'; ?>
								</td>
								<td>:</td>
								<td>
