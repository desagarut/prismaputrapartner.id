					...
					<div class="col-md-9">
						<div class="card">
							<div class="card-header">
								<a href="<?= site_url('mailbox/form') ?>" class="btn btn-success btn-sm " title="Tulis Pesan"><i class="fa fa-plus"></i> Tulis Pesan</a>
								<a href="#confirm-delete" title="Arsipkan Data" <?php if (!$filter_archived) : ?>onclick="deleteAllBox('mainform','<?= site_url("mailbox/archive_all/$kat/$p/$o") ?>')" <?php endif ?> class="btn btn-danger btn-sm  hapus-terpilih" <?php $filter_archived and print('disabled') ?>><i class='fa fa-file-archive-o'></i> Arsipkan Data Terpilih</a>
								<a href="<?= site_url("mailbox/clear/$kat/$p/$o") ?>" class="btnbg-purple btn-sm "><i class="fa fa-refresh"></i>Bersihkan Filter</a>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-sm-12">
												...
												<div class="row">
													<div class="col-sm-9">
														<div class="form-group">
															<select class="form-control form-control-sm input-sm select2 select2-nik-ajax" id="nik" style="width:100%" name="nik" data-url="<?= site_url('mailbox/list_pendaftar_mandiri_ajax') ?>" onchange="formAction('mainform', '<?= site_url("mailbox/filter_nik/$kat") ?>')">
																<?php if ($individu): ?>
														...
														<div class="form-group">
															<select class="form-control form-control-sm input-sm " name="status" onchange="formAction('mainform','<?= site_url("mailbox/filter_status/$kat") ?>')">
														...
														<div class="box-tools">
															<div class="input-group input-group-sm pull-right">
																...
																<div class="input-group-btn">
																	<button type="submit" class="btn btn-default btn-sm" onclick="$('#'+'mainform').attr('action', '<?= site_url("mailbox/search/$kat") ?>');$('#'+'mainform').submit();"><i class="fa fa-search"></i></button>
																</div>
															</div>
														</div>
													</div>
									...
									<div class='modal-dialog'>
										<div class='modal-content'>
											...
											<div class='modal-footer'>
												<button type="button" class="btn btn-warning btn-sm" data-dismiss="modal"><i class='fa fa-sign-out'></i> Tutup</button>
												<a class='btn-ok'>
													<button type="button" class="btn btn-danger btn-sm" id="ok-delete"><i class='fa fa-file-archive-o'></i> Arsipkan</button>
												</a>
											</div>
										</div>
									</div>
