...
<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Impor Data Siskeudes</h5>
		<ul class="breadcrumb">
												...
												<?php foreach ($main as $data): ?>
													<tr>
														...
														<td nowrap>
															...
															<?php endif; ?>
															<a href="#" data-href="<?= site_url("keuangan/delete/$data[id]")?>" class="btn bg-maroon btn-box btn-sm" title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
