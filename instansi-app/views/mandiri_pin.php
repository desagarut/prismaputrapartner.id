			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4 col-sm-offset-4 form-box">
						<div class="form-top">
							<a href="<?=site_url(); ?>mandiri_web/balik_first"><img src="<?=gambar_institusi($header['logo']);?>" alt="<?=$header['nama_desa']?>" class="img-responsive" /></a>
						...
						<div class="form-bottom">
							<form action="<?=site_url("mandiri_web/update_pin/$main[nik]"); ?>" method="POST" id="validasi" enctype="multipart/form-data">
								...
								<button type="submit" id="btnSubmit" class="btn btn-box btn-info btn-sm"><i class='fa fa-check'></i>Simpan</button>
								<div class="login-footer-top">
									<br /><h3>Silakan coba login kembali setelah PIN baru berhasil disimpan</h3>
								</div>
							</form>
							<div class="login-footer-bottom"><a href="https://github.com/SIDeGa/SIDeGa" target="_blank">
								SiDeGa</a> <?= AmbilVersi(); ?><br />
