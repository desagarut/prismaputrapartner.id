...
<div class="card card-primary box-solid">
	...
	<div class="card-body">
		...
		<div id="collapse2" class="panel-collapse collapse">
			<br>
			<?php if (is_file(FCPATH . LOKASI_LOGO_INSTANSI . $desa['kantor_kecamatan'])): ?>
				<img class="img-responsive" src="<?=gambar_institusi($desa['kantor_kecamatan'], TRUE)?>" alt="Kantor Desa">
				<hr>
			<?php endif; ?>
			<div class="info-desa">
