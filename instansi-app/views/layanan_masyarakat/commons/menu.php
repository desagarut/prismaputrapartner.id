...
<aside class="main-sidebar sidebar-light-maroon elevation-4"> 
  <!-- Brand Logo --> 
  <a href="<?= site_url() ?>first" target="_blank" class="brand-link"> <img src="<?= gambar_institusi($desa['logo']); ?>" alt="Logo <?= $this->setting->website_title ?>" class="brand-image img-circle elevation-3" style="opacity: .8"> <span class="brand-text font-weight-light">
