<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?= site_url('manajemen_kasus') ?>"> Daftar Kasus</a></li>
			<li class="active">Daftar Klien</li>
		</ol>
	</section>
	<section class="content" id="maincontent">
		<div class="box-header">
			<a href="<?= site_url("manajemen_kasus")?>" class="btn btn-social btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar Program Bantuan"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Daftar Program Bantuan</a>
		</div>
