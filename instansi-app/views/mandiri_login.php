...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <a href="#"><span class="logo-mini logo-text" style="padding-top:7px"><img src="<?= gambar_institusi($header['logo']); ?>" class="img-logo" style="height:50px; width:50px" alt="User Image"></span> </a>
  </div>-->
