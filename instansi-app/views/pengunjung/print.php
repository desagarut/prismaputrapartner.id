				...
				<table>
					<tbody>
						<tr>
							<td align="center" >
								<?php if ($aksi != 'unduh'): ?>
									<img src="<?= gambar_institusi($config['logo']);?>" alt="" style="width:100px; height:auto">
								<?php endif; ?>
								...
								<h5 class="m-b-10">LAPORAN DATA STATISTIK PENGUNJUNG WEBSITE <?= strtoupper($main['judul']);?></h5>
							</td>
						</tr>
						<tr>
