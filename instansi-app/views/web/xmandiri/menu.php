  ...
  <section class="sidebar">
		<div class="user-panel" style="padding-top:10px">
			<div class="pull-left image">
				<img src="<?= gambar_institusi($desa['logo']); ?>" class="img-circle" alt="User Image">
			</div>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li> <a href="<?= site_url();?>mandiri_web/mandiri_polling"><i class="fa fa-user"></i> <span> Polling</span> </a> </li>
