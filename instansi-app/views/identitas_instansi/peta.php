...
function initMap() {
    ...
    PetaDesa = new google.maps.Map(document.getElementById("peta_wilayah_kerja"), { center, zoom:<?=$wil_ini['zoom']?>, mapTypeId:google.maps.MapTypeId.<?=$wil_ini['map_tipe']?> });
    ...
    kantorDesa = new google.maps.Marker({
		...
		icon: '<?= gambar_institusi($main['logo']); ?>',
    });
...
<div class="card">
    <div class="card-body">
        <div id="peta_wilayah_kerja" class="set-map" style="height:400px;"></div>
    </div>
</div>
