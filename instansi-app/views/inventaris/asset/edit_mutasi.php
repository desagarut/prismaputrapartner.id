<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Ubah Data Mutasi Asset Lainnya</h5>
		<ul class="breadcrumb">
			<li><a href="<?= site_url('beranda')?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= site_url() ?>inventaris_asset/mutasi"><i class="fa fa-dashboard"></i>Daftar Mutasi Asset Lainnya</a></li>
	...
	<div class="card">
		<form class="form-horizontal" id="validasi" name="form_mutasi_asset" method="post" action="<?= site_url("api_inventaris_asset/update_mutasi/$main->id"); ?>">
            ...
            <div class="card-header">
						<a href="<?= site_url() ?>inventaris_asset/mutasi" class="btn btn-box btn-info btn-sm "><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Mutasi Asset Lainnya</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
