<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Isi Data Mutasi Asset Lainnya</h5>
		<ul class="breadcrumb">
	...
	<div class="card">
		<form class="form-horizontal" id="validasi" name="form_mutasi_asset" method="post" action="<?= site_url("api_inventaris_asset/add_mutasi"); ?>">
            ...
            <div class="card-header">
						<a href="<?= site_url() ?>inventaris_asset" class="btn btn-box btn-info btn-sm "><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Asset Lainnya</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
