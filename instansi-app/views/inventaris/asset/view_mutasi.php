<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Rincian Data Mutasi Asset Lainnya</h5>
		<ul class="breadcrumb">
			<li><a href="<?= site_url('beranda')?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= site_url() ?>inventaris_asset/mutasi"><i class="fa fa-dashboard"></i>Daftar Asset Lainnya</a></li>
						<li class="breadcrumb-item active">Rincian Data Mutasi</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
	...
	<div class="card">
		<form class="form-horizontal" id="validasi" name="form_asset" method="post" action="<?= $form_action?>">
            ...
            <div class="card-header">
						<a href="<?= site_url() ?>inventaris_asset/mutasi" class="btn btn-box btn-info btn-sm "><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Asset Lainnya</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
