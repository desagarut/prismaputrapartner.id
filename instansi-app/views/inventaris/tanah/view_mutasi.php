<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Rincian Mutasi Inventaris Tanah</h5>
		<ul class="breadcrumb">
		...
		<form class="form-horizontal" id="validasi" name="form_tanah" method="post" action="<?= $form_action?>">
          ...
          <?php	$this->load->view('inventaris/menu_kiri.php')?>
            ...
            <div class="card-header">
						<a href="<?= site_url() ?>inventaris_tanah/mutasi" class="btn btn-box btn-info btn-sm "><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Mutasi Inventaris Tanah</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
