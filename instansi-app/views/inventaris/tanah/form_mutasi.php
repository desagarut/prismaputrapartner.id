<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Isi Data Mutasi Inventaris Tanah</h5>
		<ul class="breadcrumb">
		...
		<form class="form-horizontal" id="validasi" name="form_mutasi_tanah" method="post" action="<?= site_url("api_inventaris_tanah/add_mutasi"); ?>">
          ...
          <?php	$this->load->view('inventaris/menu_kiri.php')?>
            ...
            <div class="card-header">
							<a href="<?= site_url() ?>inventaris_tanah" class="btn btn-box btn-info btn-sm "><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Tanah</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
