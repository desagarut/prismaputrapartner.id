<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Rincian Mutasi Inventaris Peralatan Dan Mesin</h5>
		<ul class="breadcrumb">
			...
			<li><a href="<?= site_url() ?>inventaris_tanah/mutasi"><i class="fa fa-dashboard"></i>Daftar Mutasi Inventaris Peralatan Dan Mesin</a></li>
						<li class="breadcrumb-item active">Rincian Mutasi</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
	...
	<div class="card">
		<form class="form-horizontal" id="validasi" name="form_tanah" method="post" action="<?= $form_action?>">
            ...
            <div class="card-header">
						<a href="<?= site_url() ?>inventaris_peralatan/mutasi" class="btn btn-box btn-info btn-sm "><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Mutasi Inventaris Peraltan Dan Mesin</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
