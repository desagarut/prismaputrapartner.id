<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Daftar Inventaris Peralatan Dan Mesin</h5>
		<ul class="breadcrumb">
			<li><a href="<?= site_url('beranda')?>"><i class="fa fa-home"></i> Home</a></li>
						<li class="breadcrumb-item active">Daftar Inventaris Peralatan Dan Mesin</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
	...
	<div class="card">
		<form id="mainformexcel" name="mainformexcel" action="" method="post" class="form-horizontal">
            ...
            <div class="card-header">
							<a href="<?= site_url('inventaris_peralatan/form')?>" class="btn btn-box btn-success btn-sm btn-sm "  title="Tambah Data Baru">
															...
															<?php endif; ?>
																...
																<td nowrap>
																	<?php if ($data->status == "0"): ?>
																		<a href="<?= site_url('inventaris_peralatan/form_mutasi/'.$data->id); ?>" title="Mutasi Data" class="btn bg-olive btn-box btn-sm"><i class="fa fa-external-link-square"></i></a>
																	<?php endif; ?>
																	<a href="<?= site_url('inventaris_peralatan/view/'.$data->id); ?>" title="Lihat Data" class="btn bg-info btn-box btn-sm"><i class="fa fa-eye"></i></a>
																	<a href="<?= site_url('inventaris_peralatan/edit/'.$data->id); ?>" title="Edit Data"  class="btn bg-orange btn-box btn-sm"><i class="fa fa-edit"></i> </a>
																	<a href="#" data-href="<?= site_url("api_inventaris_peralatan/delete/$data->id")?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
																</td>
