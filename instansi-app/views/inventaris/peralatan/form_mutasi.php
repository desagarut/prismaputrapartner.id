<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Isi Data Mutasi Inventaris Peralatan Dan Mesin</h5>
		<ul class="breadcrumb">
	...
	<div class="card">
		<form class="form-horizontal" id="validasi" name="form_mutasi_peralatan" method="post" action="<?= site_url("api_inventaris_peralatan/add_mutasi"); ?>">
            ...
            <div class="card-header">
						<a href="<?= site_url() ?>inventaris_peralatan" class="btn btn-box btn-info btn-sm "><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Peralatan Dan Mesin</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
