<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Isi Data Inventaris Jalan, Irigasi dan Jaringan</h5>
		<ul class="breadcrumb">
		...
		<form class="form-horizontal" id="validasi" name="form_jalan" method="post" action="<?= site_url("api_inventaris_jalan/add"); ?>">
			<div class="row">
				...
				<div class="col-md-9">
						...
						<a href="<?= site_url() ?>inventaris_jalan" class="btn btn-box btn-info btn-sm "><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Jalan, Irigasi Dan Jariangan</a>
						</div>
						<?php
