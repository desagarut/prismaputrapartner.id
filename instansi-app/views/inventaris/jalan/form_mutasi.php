<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Isi Data Mutasi Inventaris Jalan, Irigasi dan Jaringan</h5>
		<ul class="breadcrumb">
			...
			<li><a href="<?= site_url() ?>inventaris_jalan"><i class="fa fa-dashboard"></i>Daftar Inventaris Jalan, Irigasi dan Jaringan</a></li>
						<li class="breadcrumb-item active">Isi Data Mutasi</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
	...
	<div class="card">
		<form class="form-horizontal" id="validasi" name="form_mutasi_jalan" method="post" action="<?= site_url("api_inventaris_jalan/add_mutasi"); ?>">
            ...
            <div class="card-header">
						<a href="<?= site_url() ?>inventaris_jalan" class="btn btn-box btn-info btn-sm "><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Jalan, Irigasi dan Jaringan</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
