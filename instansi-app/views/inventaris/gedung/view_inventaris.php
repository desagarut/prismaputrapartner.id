<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Rincian Data Inventaris Gedung Dan Bangunan</h5>
		<ul class="breadcrumb">
	...
	<div class="card">
		<form class="form-horizontal" id="validasi" name="form_gedung" method="post" action="<?= $form_action?>">
            ...
            <div class="card-header">
						<a href="<?= site_url() ?>inventaris_gedung" class="btn btn-box btn-info btn-sm "><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Gedung Dan Bangunan</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
