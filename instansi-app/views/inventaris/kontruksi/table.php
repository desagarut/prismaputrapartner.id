	...
	<div class="page-header">
		...
		<ul class="breadcrumb">
			<li><a href="<?= site_url('beranda')?>"><i class="fa fa-home"></i> Home</a></li>
						<li class="breadcrumb-item active">Daftar Inventaris Kontruksi</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
														...
														<?php foreach ($main as $data): ?>
															<tr>
																...
																<td nowrap>
																	...
																	<a href="#" data-href="<?= site_url("api_inventaris_kontruksi/delete/$data->id")?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
																</td>
