...
<footer class="main-footer text-sm">
	<div class="float-right d-none d-sm-block hidden-xs"> <b>Version</b>
		<?= AmbilVersi() ?> <span class="logo-mini logo-text" style="padding-top:7px"></span>
	</div>
	<span class="logo-mini logo-text" style="padding-top:7px"><img src="<?= gambar_institusi($desa['logo']); ?>" class="img-logo img-circle" alt="User Image" width="30px"></span> <a href="#" target="_blank"></a> Cases Management System <?= $this->setting->website_title ?><strong><a href="#" target="_blank"></a>.</strong>
</footer>
