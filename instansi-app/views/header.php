...
<head>
	...
	<title> <?= $this->setting->admin_title
...
<body class="hold-transition light-mode <?= $this->setting->warna_tema_admin; ?> sidebar-mini layout-fixed <?php if ($minsidebar == 1) : ?>sidebar-collapse<?php endif ?> layout-navbar-fixed">
	<div class="wrapper">
