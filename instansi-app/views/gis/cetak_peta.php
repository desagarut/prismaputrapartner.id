...
<table class="title" leaflet-browser-print-content width="100%" style="border: solid 1px grey; text-align: center;">
  ...
  <tr>
    <?php if ($wilayah == $nama_wilayah) : ?>
      <td align="center"><img src="<?= gambar_institusi($wil_atas['logo']); ?>" alt="logo" class="logo_mandiri"></td>
    <?php elseif (in_array($wilayah, array(ucwords($this->setting->sebutan_dusun), "RW", "RT"))) : ?>
      <td align="center"><img src="<?= gambar_institusi($logo['logo']); ?>" alt="logo" class="logo_mandiri"></td>
    <?php else : ?>
      <td align="center"><img src="<?= gambar_institusi($desa['logo']); ?>" alt="logo" class="logo_mandiri"></td>
    <?php endif; ?>
  </tr>
  <tr>
    <td>
