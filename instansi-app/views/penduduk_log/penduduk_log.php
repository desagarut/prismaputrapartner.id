...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb"><a href="<?= site_url('beranda'); ?>"><i class="feather icon-home"></i></a></li>
						<li class="breadcrumb-item active"><a href="<?= site_url('penduduk/clear')?>">Data Kependudukan</a></li>
						<li class="breadcrumb-item active"><a href="#!">Penduduk Log</a></li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
	...
	<!-- /.content-header -->
  <section class="content" id="maincontent">		<!-- [ breadcrumb ] end -->
														...
														<tbody>
															<?php foreach ($main as $data): ?>
																<tr>
																	...
																	<td class="aksi">
																		<a href="<?= site_url("penduduk_log/edit/$p/$o/$data[id_log]")?>" class="btn bg-orange btn-box btn-sm"  title="Ubah Log Penduduk" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Ubah Log Penduduk" ><i class="fa fa-edit"></i></a>
																		<a href="#" data-href="<?= site_url("penduduk_log/kembalikan_status/$data[id_log]")?>" class="btn bg-olive btn-box btn-sm" title="Kembalikan Status"  data-remote="false"  data-toggle="modal" data-target="#confirm-status"><i class="fa fa-undo"></i></a>
																	</td>
																	<td nowrap>
